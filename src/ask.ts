...
export function buildSystemPrompt(
  ...
  return [
    ...
    `  3. the words: ${ending}.`,
    '',
    'Part 3 is NOT optional. End with those words verbatim, even when trimming to fit —',
    'the tighter budget makes dropping it the easiest corner to cut, and it is the one',
    ...
    '',
    'HARD LIMIT: 15 words in the whole line. Count them before answering. Shorter is better.',
